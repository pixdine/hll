/* flatpickr v4.6.13,, @license MIT */ ! function(e, n) {
    ...
    function m(e, n) {
        var t = d("div", "numInputWrapper"),
            ...
            o = d("span", "arrowDown");
            x = d("div", "new-year");
        if (-1 === navigator.userAgent.indexOf("MSIE 9.0") ? a.type = "text" : (a.type = "text", a.pattern = "\\d*"), void 0 !== n)
            for (var r in n) a.setAttribute(r, n[r]);
        return t.appendChild(a), t.appendChild(i), t.appendChild(o), t.appendChild(x), t
    }
